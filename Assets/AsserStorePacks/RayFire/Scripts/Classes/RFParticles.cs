    ...
    public class RFParticles
    {
        ...
        public static void CreateDemolitionDebris(RayfireRigid source)
        {
            ...
            for (int i = 0; i < source.debrisList.Count; i++)
            {
                ...
                {
                    // Get amount list
                    SetRigidDebrisFinalAmount (new List<RayfireDebris>(){source.debrisList[i]}, source.debrisList[i].emission.burstType, source.debrisList[i].emission.burstAmount);
                ...
                // Get amount list
                SetRigidDebrisFinalAmount (particlesTargets, source.debrisList[i].emission.burstType, source.debrisList[i].emission.burstAmount);
